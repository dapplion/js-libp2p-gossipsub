    ...
    reportMessageValidationResult(msgId, propagationSource, acceptance) {
        ...
        // Not valid
            ...
            if (cacheEntry) {
                ...
                let rejectReason;
                switch (acceptance) {
                    case types_1.MessageAcceptance.Ignore:
                        rejectReason = types_1.RejectReason.Ignore;
                        break;
                    case types_1.MessageAcceptance.Reject:
                        rejectReason = types_1.RejectReason.Reject;
                        break;
                }
                const { message: rawMsg, originatingPeers } = cacheEntry;
                // Tell peer_score about reject
